 ...
 * Computes the top rank against the live set (tombstones filtered, so a deleted
 * list's rank can't bound the new one) and forces folder:null. Shared by all
 * "create at top" call sites.
 */
